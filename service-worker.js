// We don't need to add a <script src="./service-worker.js"> tag,
...
// define which files we'd like to cache to the top
...
// so we don't use window.addEventListener instead
